...
class MultiSTGCnetDataset(TrafficStateCPTDataset):
    ...
    def get_data_feature(self):
        ...
        return {"scaler": self.scaler, "adj_mx": self.adj_mx,
                ...
                "output_dim": self.output_dim,"len_closeness":self.len_closeness,
                "len_period":self.len_period,"len_trend":self.len_trend}
